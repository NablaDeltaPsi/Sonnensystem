...
# parenthesis gives the version that worked with python (3.12.7) and pyinstaller (6.11.0)
# astropy (5.3.4), matplotlib (3.9.2), numpy (1.26.4), pycairo (1.27.0), scipy (1.14.1)

GUIVERSION = "3.4.2"
GUINAME = "Sonnensystem"
...
class NewGUI():
    ...
    def __init__(self, guisize, fontsize, xpos, ypos, *args):
        ...
        self.root = tk.Tk()
        self.root.title(GUINAME + " (v" + GUIVERSION + ")")
